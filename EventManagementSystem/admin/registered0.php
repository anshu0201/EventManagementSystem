...
<input type="text" class="form-control no-border" name="eno" id="inputEmail3" value="'.$row['Eno'].'">
  ...
  ?>
                      ...
                      <h3 align=center>
  <a href="https://docs.google.com/document/d/10alhmPgEqYfelrj5TEfpMFetgjWf5u6XA3ipn-CWcJw/edit" class="btn btn-info" role="button" target="_blank" >View Syllabus</a>
  </h3>
              </div>
